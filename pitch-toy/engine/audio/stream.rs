...
mod tests {
    ...
    fn test_stream_handler_creation() {
        ...
        assert_eq!(handler.get_health().state, StreamState::Disconnected);
        assert!(!handler.is_connected());
    }
    ...
    fn test_stream_handler_creation_native() {
        ...
        // Use pattern matching to avoid calling js-sys functions
        let health = handler.stream_health.borrow();
        match health.state {
            StreamState::Disconnected => assert!(true),
    ...
    fn test_stream_error_display() {
        ...
        let config_error = StreamError::ConfigurationError("Test error".to_string());
        assert_eq!(config_error.to_string(), "Stream configuration error: Test error");
    }
}