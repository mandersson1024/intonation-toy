...
- [ ] Add just intonation support with pure interval ratios based on a selectable root frequency
...
#### Modified Files
- `/src/audio/mod.rs` - Added pitch_detector module declaration and public API exports (updated with PitchDetector and PitchDetectionError)
