...
- [ ] Update `Cargo.toml` package name from "hello-yew" to "pitch-toy"
- [ ] Add required dependencies: web-sys, pitch-detection, rustfft with correct versions
- [ ] Configure crate-type as ["cdylib"] for WebAssembly output
- [ ] Update project description and repository URL
- [ ] Verify WASM compatibility of all dependencies
