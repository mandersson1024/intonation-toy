...
**Files Created**:
- `src/modules/developer_ui/hooks/use_event_subscription.rs`
- `src/modules/developer_ui/utils/event_type_registry.rs` 
- `src/modules/developer_ui/utils/debug_event_publisher.rs`
